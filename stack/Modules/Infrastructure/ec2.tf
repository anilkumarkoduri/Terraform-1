...
resource "null_resource" "ec2-webapp-setup" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
        ...
        "ansible-pull -U https://github.com/citb34/ansible-pull.git setup-stack.yml -e RDS_ENDPOINT=${var.RDS_ENDPOINT} -e RDS_USERNAME=${RDS_USERNAME} -e RDS_PASSWORD=${RDS_PASSWORD}"
     ] 
    }
}
